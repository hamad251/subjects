    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.subjects.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('department') ? 'is-invalid' : '' }}" name="department" id="department" required>
                    ...
                    @foreach(App\Models\Subject::DEPARTMENT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('department', 'dep1') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('purpose') ? 'is-invalid' : '' }}" name="purpose" id="purpose">
                    ...
                    @foreach(App\Models\Subject::PURPOSE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('purpose', '1') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_it_urgent') ? 'is-invalid' : '' }}" type="text" name="is_it_urgent" id="is_it_urgent" value="{{ old('is_it_urgent', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_it_board_powers') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_it_board_powers" id="is_it_board_powers" value="1" {{ old('is_it_board_powers', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_it_board_powers_text') ? 'is-invalid' : '' }}" type="text" name="is_it_board_powers_text" id="is_it_board_powers_text" value="{{ old('is_it_board_powers_text', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_it_related') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_it_related" id="is_it_related" value="1" {{ old('is_it_related', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_it_financial_related') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_it_financial_related" id="is_it_financial_related" value="1" {{ old('is_it_financial_related', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_it_market_effect') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_it_market_effect" id="is_it_market_effect" value="1" {{ old('is_it_market_effect', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_it_edit_related') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_it_edit_related" id="is_it_edit_related" value="1" {{ old('is_it_edit_related', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_it_decision_related') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_it_decision_related" id="is_it_decision_related" value="1" {{ old('is_it_decision_related', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_it_public') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_it_public" id="is_it_public" value="1" {{ old('is_it_public', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_it_related_to_old_subject') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_it_related_to_old_subject" id="is_it_related_to_old_subject" value="1" {{ old('is_it_related_to_old_subject', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('time') ? 'is-invalid' : '' }}" type="number" name="time" id="time" value="{{ old('time', '5') }}" step="1">
                @if($errors->has('time'))
                    <div class="invalid-feedback">
                        {{ $errors->first('time') }}
                    </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_it_department_related') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_it_department_related" id="is_it_department_related" value="1" {{ old('is_it_department_related', 0) == 1 ? 'checked' : '' }}>
